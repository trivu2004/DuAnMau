...
public class QuanLyKhoaHoc extends javax.swing.JFrame {
    ...
    private boolean isValidInput() {
        if (cboChuyenDe.getSelectedItem() == null) {
            DialogHelper.alert(this, "Vui lòng chọn chuyên đề.");
            return false;
        }
        if (txtGhiChu.getText().equals("")) {
            DialogHelper.alert(this, "Vui lòng nhập ghi chú.");
            return false;
        }

        if (txtNgayKG.getText().isEmpty()) {
            DialogHelper.alert(this, "Vui lòng nhập ngày khai giảng.");
        ...
        // Kiểm tra các điều kiện validate khác ở đây.
        return true;
    }
    ...
    void selectComboBox() {
        ...
        if (selectedItem instanceof ChuyenDe) {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.setFont(new java.awt.Font("Segoe UI", 0, 30)); // NOI18N

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 28)); // NOI18N
        jLabel1.setText("Chuyên Đề");

        cboChuyenDe.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        txtNgayKG.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        ...
        txtGhiChu.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
        txtGhiChu.setRows(5);
        ...
        btnStudents.setFont(new java.awt.Font("Segoe UI", 0, 24)); // NOI18N
                                        ...
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                                ...
                                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                    ...
                                                    .addComponent(cboChuyenDe, javax.swing.GroupLayout.PREFERRED_SIZE, 435, javax.swing.GroupLayout.PREFERRED_SIZE)
                                                    .addComponent(jLabel3)))
                                            .addComponent(jLabel5)
                                            .addComponent(txtHocPhi, javax.swing.GroupLayout.PREFERRED_SIZE, 435, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGap(156, 156, 156)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnNext)
                    .addComponent(btnLast)
                    .addComponent(btnStudents, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(84, 84, 84))
        );
    ...
    private void tblGridViewMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblGridViewMouseClicked
        ...
        if (evt.getClickCount() == 1) {
            ...
            if (this.index >= 0) {
                ...
                // Lấy giá trị từ bảng tại chỉ số (index) dòng được click và cột "Chuyên Đề".
                String maCD = tblGridView.getValueAt(index, 2).toString(); // Chuyên đề

                // Lấy mô hình của JComboBox để thao tác với dữ liệu bên trong nó.
                DefaultComboBoxModel model = (DefaultComboBoxModel) cboChuyenDe.getModel();
                // Duyệt qua các phần tử của mô hình ComboBox để tìm phần tử có mã CD tương tự.
                for (int i = 0; i < model.getSize(); i++) {
                    ChuyenDe chuyenDe = (ChuyenDe) model.getElementAt(i);
                    // So sánh mã CD của phần tử trong mô hình ComboBox với mã CD từ bảng.
                    if (chuyenDe.getMaCD().equals(maCD)) {
                        // Nếu tìm thấy mã CD giống nhau, đặt giá trị của JComboBox thành phần tử tại vị trí i.
                        cboChuyenDe.setSelectedIndex(i);
                        // Dừng vòng lặp vì đã tìm thấy mã CD tương ứng.
                        break;
                    }
                }
            }
